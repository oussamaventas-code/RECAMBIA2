    ...
    <div className="fixed bottom-5 right-5 z-40 flex items-center gap-2 sm:bottom-6 sm:right-6">
      ...
      <Magnetic strength={0.4}>
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-success text-white shadow-xl shadow-success/30 transition-colors hover:bg-success-glow"
        >
